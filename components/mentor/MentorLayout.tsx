...
interface MentorLayoutProps {
  ...
  currentPage: "dashboard" | "trainees" | "settings" | "rankings";
}

const MentorLayout = ({ children, currentPage }: MentorLayoutProps) => {
  ...
  const navigation = [
    ...
    {
      name: "Trainees",
      href: "/mentor/trainees",
      icon: Users,
      current: currentPage === "trainees",
    },
    {
      name: "Rankings",
      href: "/mentor/rankings",
      icon: Trophy,
